...
** Last update Fri Jul  3 00:10:44 2015 Emmanuel Chambon
*/
...
struct timespec				*timespec_clock_to_timespec_cp(clock_t t);
struct timespec				*timespec_clock_to_timespec_ptr(clock_t *t);
